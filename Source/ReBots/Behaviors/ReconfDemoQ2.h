 ...
 * 
 */
class REBOTS_API ReconfDemoQ2Behavior : public RobotModuleBehavior
{
	///Basic behavior data
	...
	int ReconfCounter2 = 0; /**< reconfiguration counter */
	...
	bool HaveWaitedBeforeReconfigure2  = false; /**< have waited before second reconfigure */
	bool HaveReconfigured2 = false; /**< have we performed reconfigure */
	bool HaveFoundAnglesForReconfigure2 = false; /**< have we found angles for reconfigure*/
	bool HavePlannedToReconfigureAngles2 = false; /**< have we planned to reconfigure angles */
	bool HaveExecutedReconfigureAngles2 = false; /**< have we executed reconfigure angles */
	bool HaveWaitedReconfigure12 = false; /**< have waited 1 */
	bool HaveWaitedReconfigure22 = false; /**< have waited 2 */
	bool HaveReconfigured = false; /**< have we performed reconfigure */
	bool HavePlannedTo0AfterRe1 = false; /**< have planned to 0 after reconfigure 1*/
	bool HaveExecutedTo0AfterRe1 = false; /**< have executed after reconfigure 1 */
	bool HaveWaitedBeforeRe2 = false; /**< have waited before reconfigure 2 */
	bool FinalPlanTo0 = false;
	bool FinalExecuteTo0 = false;
	bool FinalGrabFindAngles = false;
	bool FinalGrabPlan = false;
	bool FinalGrabExecute = false;
	bool FinalPostGrabWait = false;
	bool FinalPostGrabPlanTo0 = false;
	bool FinalPostGrabExecute = false;
	bool FinalPostGrabWait1 = false;
	bool FinalPostGrabWait2 = false;
	bool FinalHavePicked = false;
...
public:
	...
	* @brief constructor
	*/
	ReconfDemoQ2Behavior();
	/**
	* @brief constructor
	* @param W world
	* @param NameOfModule name of module
	*/
	ReconfDemoQ2Behavior(UWorld* W, std::string NameOfModule);
	/**
	* @brief destructor
	*/
	virtual ~ReconfDemoQ2Behavior();
	...
	*/
	void ReconfigureManipulatorTreeToSnake();
	/**
	* @brief reconfigure manipulator snake
	*/
	void ReconfigureManipulatorSnakeToTree();
	...
	* @return true if process completed, false otherwise
	*/
	bool FindGoalAnglesForReconfigureToSnake();
	/**
	* @brief find optimal goal angles for reconfiguration
	* @return true if process completed, false otherwise
	*/
	bool FindGoalAnglesForReconfigureToTree();
	/**
	...
	* @return fitness value
	*/
	float FitnessReconfigure2(BranchBoundParticle P, std::vector<float> start, std::vector<float> target);
	/**
