...
class REBOTS_API SnakeIKBehavior : public RobotModuleBehavior
{
	///Basic behavior data
	...
	int TestNumKey = 2500;
	vector<IKTestResult> IKTestResultVec; /**< vector of ik test results */
...
public:
	...
	*/
	SnakeIKBehavior(UWorld* W, std::string NameOfModule);
	/**
	* @brief destructor
	*/
	virtual ~SnakeIKBehavior();
	/**
